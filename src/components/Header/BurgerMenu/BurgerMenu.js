...
function BurgerMenu({isOpen}) {
  return (
    <div className={ (isOpen ? "bg-lele-orange font-brandon-med  uppercase tracking-widest text-lg" : "translate-x-full visible") + " ease-in-out duration-500"}>
      <nav className={isOpen ? "" : "hidden"}>
          <ul className="text-lele-blue font-bold">
              ...
              <NavLink 
                ...
                >
                  <svg 
                    className="text-lele-blue fill-current w-5 mr-5" 
              ...
              <li className="py-5 text-center">
                ...
                >
                  <svg 
                    className="text-lele-blue fill-current w-8 mr-5"
              ...
              <li className="py-5 text-center">
                ...
                >
                  <svg 
                    className="text-lele-blue fill-current w-6 mr-5" 
                    viewBox="8 15 48 34"
                  >            
